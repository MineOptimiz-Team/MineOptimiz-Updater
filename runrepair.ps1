...
(Get-Content ".\Update.bat") -replace 'ghproxymirror-stable', 'https://mirror.ghproxy.com/https://github.com/MineOptimiz-Team/MineOptimiz-3rd/archive/refs/heads/1.20.1-Forge.zip' | Set-Content ".\Update.bat"
(Get-Content ".\Update.bat") -replace 'branch-stable', '1.20.1-Forge' | Set-Content ".\Update.bat"
...
(Get-Content "$updatedir\update-mirror-ghproxy-dev.sh") -replace 'branch', '1.20.1-Forge' | Set-Content "$updatedir\update-mirror-ghproxy-stable.sh"
(Get-Content "$updatedir\update-mirror-ghproxy-dev.sh") -replace 'ghproxymirror-stable', 'https://mirror.ghproxy.com/https://github.com/MineOptimiz-Team/MineOptimiz-3rd/archive/refs/heads/1.20.1-Forge.zip' | Set-Content "$updatedir\update-mirror-ghproxy-stable.sh"
