...
# 替换字符串
(Get-Content ".\Update.bat") -replace '%stabledownloadlink%', 'https://nightly.link/MineOptimiz-Team/MineOptimiz-3rd/workflows/main/1.20.1-Forge-Stable' | Set-Content ".\Update.bat"
...
(Get-Content "$updatedir\update-stable.sh") -replace 'stabledownloadlink', 'https://nightly.link/MineOptimiz-Team/MineOptimiz-3rd/workflows/main/1.20.1-Forge-Stable' | Set-Content "$updatedir\update-stable.sh"
