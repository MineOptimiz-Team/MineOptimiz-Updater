...
echo "正在下载更新包中..."
wget ghproxymirror -O Update.zip || exit 1
echo "正在解压更新包..."
unzip Update.zip
...
find ./mods -type f ! -name "exordium*" ! -name "entityculling*" ! -name "fancymenu*" ! -name "notenoughanimations*" ! -name "viafabricplus*" ! -name "voicechat*" ! -name "skinlayers3d*" ! -name "OptiFine*" ! -name "modpack-update-checker*" -exec rm -f {} +
rm -rf ./resourcepacks
echo "正在复制新的文件..."
