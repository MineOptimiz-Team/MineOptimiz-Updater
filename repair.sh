...
sed -i "s~ghproxymirror-stable~https://mirror.ghproxy.com/https://github.com/MineOptimiz-Team/MineOptimiz-3rd/archive/refs/heads/1.20.1-Forge.zip~g" $modpackdir/Update.bat
sed -i "s~branch~1.20.1-Forge-Dev~g" $modpackdir/Update.bat
sed -i "s~branch-stable~1.20.1-Forge~g" $modpackdir/Update.bat
...
sed -i "s~ghproxymirror-stable~https://mirror.ghproxy.com/https://github.com/MineOptimiz-Team/MineOptimiz-3rd/archive/refs/heads/1.20.1-Forge.zip~g" $updatedir/update-mirror-ghproxy-stable.sh
sed -i "s~branch~1.20.1-Forge~g" $updatedir/update-mirror-ghproxy-stable.sh
